...
let footerComponent = `
        <div class="container">
            <div class="row g-3 text-white mb-4">
                ...
                <div class="col-lg-3 col-md-6 col-12 ps-lg-5">
                    ...
                    <ul class="list-unstyled social-icons d-flex flex-row">
                        <li><a href="https://www.instagram.com/walid.anadif/" target="_blank" aria-label="share account">
            ...
            <p class="text-white m-0 pb-3"><i class="fa-solid fa-copyright"></i> 2025, Gaming With Us, Developed by <a
                    class="link-git" href="https://www.instagram.com/walid.anadif/" target="_blank">WALID ANADIF</a></p>
        </div>`
